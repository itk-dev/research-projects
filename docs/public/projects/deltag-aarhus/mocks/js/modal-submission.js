  ...
  form.addEventListener("submit", function(e) {
    ...
    modalBody.innerHTML =
      '<div class="submission-success">' +
        ...
        '<p class="submission-success__text">Dit høringssvar er modtaget og vil indgå i den politiske behandling af Lokalplan nr. ' + DM.config.planNumber + '. Du modtager en bekræftelse på e-mail.</p>' +
